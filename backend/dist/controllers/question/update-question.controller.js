...
const update_question_service_1 = require("../../services/question/update-question.service");
async function updateQuestionController(req, res) {
    try {
        const { id } = req.params; //LKJ5587999939131
        const { statement, explanation, difficulty, type, bank, subjectId, options, } = req.body;
        const question = await (0, update_question_service_1.updateQuestion)(id, statement, explanation, difficulty, type, bank, subjectId, options);
...
//# sourceMappingURL=update-question.controller.js.map