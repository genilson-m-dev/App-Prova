...
const update_subject_service_1 = require("../../services/subject/update-subject.service");
async function updateSubjectController(req, res) {
    try {
        const { id } = req.params; //
        const { name, themeId } = req.body;
        const subject = await (0, update_subject_service_1.updateSubject)(id, name, themeId);
...
//# sourceMappingURL=update-subject.controller.js.map