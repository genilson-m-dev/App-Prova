...
const create_subject_service_1 = require("../../services/subject/create-subject.service");
async function createSubjectController(req, res) {
    try {
        const { name, themeId } = req.body;
        const subject = await (0, create_subject_service_1.createSubject)(name, themeId);
...
//# sourceMappingURL=create-subject.controller.js.map