...
async function getQuestionsBySubject({ subjectId, page = 1, limit = 20, }) {
    // =========================
    ...
    const [questions, total] = await Promise.all([
        prisma_1.prismaDB.question.findMany({
            where: {
        ...
        prisma_1.prismaDB.question.count({
            where: {
                subjectId: normalizedSubjectId,
            },
        }),
...
//# sourceMappingURL=get-subject-by-id.service.js.map