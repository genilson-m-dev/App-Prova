...
async function updateSubject(id, name, themeId) {
    if (typeof id !== "string") {
    ...
    const existingSubject = await prisma_1.prismaDB.subject.findFirst({
        where: {
            name: normalizedName,
    ...
    const updatedSubject = await prisma_1.prismaDB.subject.update({
        where: {
            id: normalizedId,
        },
        data: {
...
//# sourceMappingURL=update-subject.service.js.map